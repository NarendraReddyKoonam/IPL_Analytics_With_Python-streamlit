...
image = Image.open('/Users/narendrareddy/Downloads/Streamlit-main/ipl.jpg')
st.image(image)
...
def load_data():
    data=pd.read_csv('/Users/narendrareddy/Downloads/Streamlit-main/IPL Matches 2008-2020.csv')
    return data
matches_df=load_data()
def load_data():
    data1=pd.read_csv("/Users/narendrareddy/Downloads/Streamlit-main/cleaned.csv")
    return data1
...
#total man_of_the_match winners dataframe together
